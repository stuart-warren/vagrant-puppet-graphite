class graphite::web::params {
    ...
    $dashboard_conf            = 'dashboard.conf' #
    $graph_templates_conf      = 'graphTemplates.conf' #
    ...
    $local_carbon_instances    = ['127.0.0.1:7002:a','127.0.0.1:7102:b','127.0.0.1:7202:c'] #
